...
$sliderpro_slider_settings_lists = array('align_type' => array('leftTop', 'centerTop', 'rightTop', 'leftCenter', 'centerCenter', 'rightCenter', 'leftBottom', 
										 ...
										 'dynamic_posts_relation' => array('or', 'and'),

										 'dynamic_posts_operator' => array('IN', 'NOT IN'),
										 
										 'dynamic_posts_orderby' => array('date', 'comment_count', 'title', 'rand'),
										 
										 'dynamic_posts_order' => array('DESC', 'ASC'),
										 
										 'dynamic_gallery_type' => array('attached-images', 'gallery-images'),
...
$sliderpro_settings_pretty_name = array('leftTop' => __('Top Left', 'slider_pro'), 'centerTop' => __('Top Center', 'slider_pro'), 'rightTop' => __('Top Right', 'slider_pro'), 
										...
										'scale' => __('Scale', 'slider_pro'), 'width' => __('Width', 'slider_pro'), 'height' => __('Height', 'slider_pro'), 'random' => __('Random', 'slider_pro'),
									   	...
									   	'attached-images' => __('Attached Images', 'slider_pro'), 'gallery-images' => __('Gallery Images', 'slider_pro'),
...
$sliderpro_properties_help = array('width' => __('The total width of the slider. 
									...
									'disable_right_click' => __('Disables the right-click menu for images.', 'slider_pro') .'<br/><br/><b>'. 
												 			 __('Setting Name: ', 'slider_pro') .'</b><i> disableRightClick </i>', 
									...
									'thumbnail_border' => __('Indicates whether the thumbnail\'s border will be visible.', 'slider_pro') .'<br/><br/><b>'.
														  __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_border </i>', 
									
									'thumbnail_background' => __('Indicates whether the thumbnail\'s background color will be visible.', 'slider_pro') .'<br/><br/><b>'.
															  __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_border </i>', 

									'thumbnail_glow' => __('Indicates whether the thumbnail\'s glow/shadow will be visible.', 'slider_pro') .'<br/><br/><b>'.
														__('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_border </i>', 
									...
									'dynamic_posts_order' => __('Indicates whether posts will be ordered in ascending or descending order.', 'slider_pro') . '<br/><br/><b>'. 
															 __('Setting Name: ', 'slider_pro') .'</b><i> dynamic_posts_order </i>', 

									'dynamic_posts_orderby' => __('Indicates the parameter by which the posts will be ordered.', 'slider_pro') . '<br/><br/><b>'. 
															   __('Setting Name: ', 'slider_pro') .'</b><i> dynamic_posts_orderby </i>', 

									'dynamic_posts_relation' => __('Indicates whether posts that will be loaded need to have all the selected taxonomy terms (AND) or at least one (OR).', 'slider_pro') . '<br/><br/><b>'. 
															    __('Setting Name: ', 'slider_pro') .'</b><i> dynamic_posts_relation </i>', 
  
									'dynamic_posts_operator' => __('Indicates whether posts that will be loaded need to have the selected taxonomy terms (IN) or need to not have them (NOT IN).', 'slider_pro') . '<br/><br/><b>'. 
															    __('Setting Name: ', 'slider_pro') .'</b><i> dynamic_posts_operator </i>', 
									...
									'dynamic_gallery_type' => __('Indicates whether the slider will load images attached/uploaded to the post, 
																  or images from a gallery that was added to that post.', 'slider_pro') . '<br/><br/><b>'. 
															  __('Setting Name: ', 'slider_pro') .'</b><i> dynamic_gallery_type </i>',
