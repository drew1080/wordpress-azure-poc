...
<div id="intro">
	<p><strong>For support and any queries, please contact us at our support center: <a href="http://support.bqworks.com">support.bqworks.com</a></strong></p>
</div>
...
<section id="updating">
	...
	<div class="alert alert-info">NOTE:</strong> Since version 3.6 the slider uses only "div" elements in the HTML markup, instead of "ul" or "li" elements, in order to avoid CSS conflcits with themes. If you have custom CSS code that targets the "ul" or "li" elements, please target those elements using the class names instead: ".slides" and ".slide".</div>
...
<section id="create">
    ...
    <div class="row">
		<div class="span6">
        	<p>The slider provides over 150 options and they are grouped in several panels. Inside each panel, the options are grouped again in order to make it easier to find a certain option.</p>
			<p>When you open a panel, the options will be visible by default to offer you a quick overview of all the available options, but you can hide them all or only some groups if you want to make the interface cleaner. The state of the panels and inner groups will be saved when you update the slider.</p>
			<p>These global options can be overridden by options specified for individual slides in the slide's 'Settings' panel.</p>
		</div>
		
		<div class="span6">			
			<img src="<?php echo plugins_url('/slider-pro/includes/help/'); ?>assets/img/slider_options.jpg">
		</div>
	</div>
		...
		<div class="span12">
		    ...
		    <table class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						<td>dynamic_gallery_type</td>
						<td>'attached-images' or 'gallery-images'</td>
		            </tr>
...
<section id="dynamic">
	...
	<div class="row">
		<div class="span5">
			...
			<h5 id="post-taxonomies">Post Taxonomies</h5>
			...
			<p class="alert alert-info"> <strong>NOTE:</strong> For performance purposes, it's recommended to use as few taxonomy terms as possible. To avoid accidental or uninformed use of too many taxonomy terms, the slider will not allow the selection of more than 5 terms. In order to fetch posts, the slider uses a native WordPress function (i.e., WP_Query) and this function can become slow if you use too many taxonomy terms.</p> 
			
			<p>In practice, the situations when you need to use more than 5 taxonomy terms are very rare; most of the times only one taxonomy term is used (e.g., fetching posts from one category, or posts that contain a certain tag). Here are some solutions when you think you need to use more taxonomy terms than the current limit:</p>
			
			<ul>
				<li>When you want to load all posts from a certain post type, you actually don't have to select any taxonomy term; you only need to select the posty type and the slider will load all posts from that type.</li>
				<li>When you want to load almost all posts but exclude a few, you can select only the taxonomy terms attached to posts that you want excluded and set the 'Operator' option to 'NOT IN'.</li>
				<li>When you want to filter posts based on more taxonomies and the situations described above don't apply, I recommend creating a new category or tag to be used inside the slider. For example, you create a 'my-slider' tag and add this tag to all posts that you want loaded in the slider. Then, inside the slider you select only the 'my-slider' tag.</li>
			</ul>
			...
			<h5>Operator</h5>
			<p>The 'Operator' option will indicates whether posts that will be loaded need to have the selected taxonomy terms (IN) or need to not have them (NOT IN).</p>
	...
	<div class="row">
		<div class="span5">
			<p>This type of dynamic slide also provides a few controls.</p>

			<h5>Post</h5>
			<p>The 'Post' option allows you to specify the ID of the post from where images will be fetched. If you leave this option to -1, the images will be fetched from the post where the slider is inserted. This would probably be the most common use but for flexibility you can also fetch images from a different post.</p> 
			
			<h5>Maximum</h5>
			<p>The 'Maximum' option sets the maximum number of images that will be loaded.</p>
			
			<h5>Offset</h5>
			<p>'Offset' sets the index/position from where the fetching will start.</p>
			
			<h5>Type</h5>
			<p>Indicates whether the slider will load images attached/uploaded to the post, or images from a gallery that was added to that post.</p>
...
<section id="troubleshooting">
	...
	<p>If something doesn't work as expected, the first thing you need is a little patience :) and the assurance that you have my free assistance for resolving the problem. Please see if the indications below help, and if they don't please kindly email me and I'll gladly help you. You can reach me at the support center: <a href="http://support.bqworks.com">support.bqworks.com</a></p>
	
	
	<h4 id="troubleshooting1">1. The slider doesn't show up on the page</h4>
	
	<h5>a) JavaScript errors</h5>
	
	<p>First, it's important to check if you have any JavaScript errors on the page that contains the slider. JavaScript errors thrown by other scripts can break all the JavaScript functionality that follows on that page, including the slider. I would like to note that Slider PRO follows WordPress development best practices and is actively maintained to make sure it's bug free and works seamlessly. However, when something else (another plugin or theme) breaks in the site, it can affect the slider as well, as mentioned before. Most of the times it's possible to check where the problem comes from, and I will show you 2 methods. If you find the instructions below too complicated, please contact me instead.</p> 
	
	<h6>First method</h6>
	<p>Please open Chrome or Safari, and navigate to the page that should contain the slider. Then, press the F12 key if you're on Windows, and Option + Command + I if you're on Mac. Alternatively, you can right-click and select "Inspect element" on both systems. After the "Developer Tools" is opened please click on the "Console" tab. You will be able to see there all the errors and warnings that occur on the page. Some of them can be ignored but others need to be addressed, especially if they are JavaScript errors.</p> 
	
	<p>On the left side you will see the error message and on the right side you will see the name/path of the script that contains the error (if the full path of the script is not displayed please hover the text, and the full path should appear). By looking at the path of the script you can identify the theme or plugin that causes the error. If the error comes from another theme or plugin, and not Slider PRO, it's best to contact the developer of that theme/plugin, so he can fix the error. If you have difficulties interpreting the data from Console, please try the second method or contact me via the <a href="http://support.bqworks.com">support center</a> and I will be happy to assist you.</p>
	
	<h6>Second method</h6>
	<p>This method is very simple but normally you would use it only if you can't find the problem using the first method.<p>
	<p>What you need to do is temporarily deactivate the current theme and then the plugins one by one and test each time if the problem has disappeared. This way you can find which theme/plugin causes the problem.</p>	
	<p>If you identify the problem as being caused by a theme or another plugin, it's best to contact the developer of that theme/plugin, so he can fix the problem. It's in the best interests of both the developer of the theme/plugin and its user that the theme/plugin doesn't cause errors because a buggy theme/plugin could cause even more problems in the future.</p>
	
	<h5>b) Missing wp_footer() call</h5>
	
	<p>If you don't see any errors in the Console, it's possible that the theme is missing some elements: the wp_head() and wp_footer() calls. These calls are used by many plugins, including this slider, to insert the necessary scrips in the page.</p>
...
&lt;/body&gt;
	...
	<p>If that wasn't the problem either, please contact me via the support center at <a href="http://support.bqworks.com">support.bqworks.com</a>, and I will gladly help you.</p>
	...
	<p>If you're using HostGator as your hosting provider, you will need to contact them and request 'mod_security whitelisting'. Please read <a href="http://support.hostgator.com/articles/specialized-help/technical/timthumb-basics">this</a>.</p>
	
	<h5>c) Temporary URL</h5>
	
	<p>Another possible problem would be the use of a temporary URL (i.e. http://123.45.67.8/~username/). TimThumb doesn't support temporary URLs, so you might have to disable it until you move the site to a domain name. You can disable TimThumb from within the Slider PRO -> Plugin Options page.</p>
...
AddType video/x-m4v .m4v
	...
	<h5>a) Too many slides</h5>
	
    <p>You added too many slides, like 40, 50 or above. When this happens it means that some of the server's variables are set to low values and you will need to increase them. These variables can be found in the php.ini file, in case you have access to it. If not, please contact your hosting provider and ask them to increase the value for you. These are the variables that need to be increased:
    <ul>
	...
	<h5>b) HTML form element inside the slide</h5>
	
    <p>The slider's admin interface itself is a form, and having a form inside another form is not allowed and will cause problems. A workaround for this situation is to add the form using a shorcode.</p>
	
	<h5>c) XML-DOM library is not installed</h5>
	
    <p>XML-DOM library is not installed. This potential problem is more difficult to detect but when none of the above situations apply, you can consider this problem. Your hosting provider will be able to confirm if the XML-DOM library is installed. This library is used by the plugin to save each slider in an XML format, which allows you to export and import sliders. You can disable this feature, if you want, from within the Slider PRO -> Plugin Options page.</p>

    <hr />
	
    <h4 id="troubleshooting9">9. The slider's admin area doesn't work</h4>
    
	<p>We will need to check if there are any JavaScript errors in the slider's admin area. JavaScript errors thrown by other scripts can break all the JavaScript functionality that follows on that page, including the slider. I would like to note that Slider PRO follows WordPress development best practices and is actively maintained to make sure it's bug free and works seamlessly. However, when something else (another plugin or theme) breaks in the site or doesn't follow WordPress best practices, it can affect the slider as well, as mentioned before. Most of the times it's possible to check where the problem comes from, and I will show you 2 methods. If you find the instructions below too complicated, please contact me instead.</p>
	
    <h6>First method</h6>
	<p>Please open Chrome or Safari in the slider's admin area. Then, press the F12 key if you're on Windows, and Option + Command + I if you're on Mac. Alternatively, you can right-click and select "Inspect element" on both systems. After the "Developer Tools" is opened please click on the "Console" tab. You will be able to see there all the errors and warnings that occur on the page. Some of them can be ignored but others need to be addressed, especially if they are JavaScript errors.</p> 
	
	<p>On the left side you will see the error message and on the right side you will see the name/path of the script that contains the error (if the full path of the script is not displayed please hover the text, and the full path should appear). By looking at the path of the script you can identify the theme or plugin that causes the error. If the error comes from another theme or plugin, and not Slider PRO, it's best to contact the developer of that theme/plugin, so he can fix the error. If you have difficulties interpreting the data from Console, please try the second method or contact me via the <a href="http://support.bqworks.com">support center</a> and I will be happy to assist you.</p>
	
	<h6>Second method</h6>
	<p>This method is very simple but normally you would use it only if you can't find the problem using the first method.<p>
	<p>What you need to do is temporarily deactivate the current theme and then the plugins one by one and test each time if the problem has disappeared. This way you can find which item causes the problem. If you identify the problem as being caused by a theme or another plugin, it's best to contact the developer of that theme/plugin, so he can fix the problem. Most of the times the fix consists of making some code edits to the theme/plugin so that it follows WordPress development best practices. It's in the best interests of both the developer of the theme/plugin and its user that the theme/plugin follows best practices because a theme/plugin that doesn't comply to best practices could cause even more problems in the future.</p>
	...
	<h4 id="troubleshooting16">16. Slider information disappeared after I moved the site</h4>
	
	<p>If you edited the site's database to change some file paths or other content, it could be the reason why the slider's information is not displayed anymore. The slider's content is serialized in the database, and editing it manually can corrupt serialized data. In order to fix it, and whenever you need to edit data directly in the database, please use this script: <a href="http://interconnectit.com/124/search-and-replace-for-wordpress-databases/">Search Replace DB</a></p>
...
<section id="changelog">
	...
	<h3>Files added or modified in version 3.6</h3>
	<ul class="custom-list">
		<li>slider-pro/slider-pro.php</li>
		<li><b>slider-pro/includes &#9660;</b></li>
		<li>slider-pro/includes/sliders.php</li>
		...
		<li>slider-pro/includes/plugin-options.php</li>
		<li>slider-pro/includes/posts-data-fields.php</li>
		<li>slider-pro/includes/gallery-data-fields.php</li>
		<li>slider-pro/includes/help/help.php</li>
		<li>slider-pro/includes/help/assets/img/slider_options.jpg</li>
		<li><b>slider-pro/js &#9660;</b></li>
		<li>slider-pro/js/slider-pro-admin.js</li>
		<li>slider-pro/js/jquery.multiselect.min.js</li>
		<li>slider-pro/js/jquery.multiselect.filter.min.js</li>
		<li>slider-pro/js/dev/jquery.multiselect.js</li>
		<li>slider-pro/js/dev/jquery.multiselect.filter.js</li>
		<li>slider-pro/js/slider/jquery.advancedSlider.min.js</li>
		<li>slider-pro/js/slider/jquery.prettyPhoto.custom.min.js</li>
		<li>slider-pro/js/slider/dev/jquery.advancedSlider.js</li>
		<li>slider-pro/js/slider/dev/jquery.prettyPhoto.custom.js</li>
		<li><b>slider-pro/css &#9660;</b></li>
		<li>slider-pro/css/slider-pro-admin.css</li>
		<li>slider-pro/css/slider/advanced-slider-base.css</li>
		<li>slider-pro/css/slider/prettyPhoto.css</li>
		<li><b>slider-pro/languages &#9660;</b></li>
		<li>slider-pro/languages/slider_pro.po</li>
		<li>slider-pro/languages/slider_pro.mo</li>
	</ul>
