    	...
    	<table>
			...
			<tr>
	        	<td>
	            	...
	            	<label>Enqueue jQuery 1.9.1</label>
	            </td>
	        	<td>
	            	<p>You can enable this option if you have an older version of WordPress, which doesn't include at least jQuery 1.6.</p>
	            </td>
	        </tr>
	        ...
	        <tr>
	        	<td>
	            	...
	            	<label>Show "Getting Started" message</label>
	            </td>
	        	<td>
	            	<p>Indicates whether the "Getting Started" message will be displayed in the Sliders page.</p>
	            </td>
	        </tr>
	        ...
	        <tr>
	        	<td>
	            	...
	            	<label>Display all slider options</label>
	            </td>
	        	<td>
	            	<p>Indicates whether all the slider's options will be visible by default. If disabled, the options will be hidden dy default, and displayed only if they are selected.</p>
	            </td>
	        </tr>
