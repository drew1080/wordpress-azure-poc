<div class="wrap slider-pro">
	...
	<?php
		if (get_option('slider_pro_show_getting_started_message')) {
	?>

	    <div class="getting-started updated">
			<h3>1. Getting started</h3>
			<p>If you want to reproduce one of the examples you've seen on <a href="http://sliderpro.net">sliderpro.net</a>, you can easily import those examples into your own Slider PRO installation.</p>
			<p>The examples can be found in the 'examples' folder (which is inside the main downloaded package), and can be imported using the 'Import Slider' button below.</p>
			<p>You can use these examples as a starting point for your own sliders or simply to learn how certain features are achieved.</p>
			<p>For other instructions please see the <a href="<?php echo admin_url('admin.php?page=slider_pro_help'); ?>">Help</a> page.</p>

			<h3>2. Support</h3>
			<p>When you need support, please contact us at our support center: <a href="http://support.bqworks.com">support.bqworks.com</a></p>
