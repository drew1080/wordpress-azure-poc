...
$sliderpro_slider_settings = array( // general settings
									...
									'scale_type' => array('default_value' => 'outsideFit', 
														  ...
														  'list' => 'scale_type',
														  'category' => 'general',
														  'group' => __('Image Scale and Align', 'slider_pro')),
									...
									// other settings
									'disable_right_click' => array('default_value' => false, 
													   			 'name' => __('Disable Right Click', 'slider_pro'), 
													   			 'type' => 'checkbox',
													   			 'category' => 'general',
													   			 'group' => __('Other', 'slider_pro')),
									...
									'slide_buttons' => array('default_value' => true, 
														  	 ...
														  	 'type' => 'checkbox',
															 'category' => 'slide_navigation_controls',
															 'group' => __('Slide Buttons', 'slider_pro')),
									...
									'thumbnail_border' => array('default_value' => true, 
																'name' => __('Thumbnail Border', 'slider_pro'), 
																'type' => 'checkbox', 
																'category' => 'thumbnails',
																'group' => __('Style', 'slider_pro')),
															  
									'thumbnail_background' => array('default_value' => true, 
																	'name' => __('Thumbnail Background', 'slider_pro'), 
																	'type' => 'checkbox', 
																	'category' => 'thumbnails',
																	'group' => __('Style', 'slider_pro')),

									'thumbnail_glow' => array('default_value' => true, 
															  'name' => __('Thumbnail Glow', 'slider_pro'), 
															  'type' => 'checkbox', 
															  'category' => 'thumbnails',
															  'group' => __('Style', 'slider_pro')),
...
$sliderpro_slide_dynamic_settings = array('slide_type' => 'static',
										  ...
										  'dynamic_gallery_type' => 'attached-images',
