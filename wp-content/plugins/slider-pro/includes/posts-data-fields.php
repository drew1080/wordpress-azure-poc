<div class="dynamic-fields posts-data-fields">
	...
	<label title="dynamic_posts_relation"><?php _e('Relation', 'slider_pro'); ?></label>
	<select name="slide[<?php echo $counter;?>][settings][dynamic_posts_relation]">
		<?php 
	...
	<label title="dynamic_posts_operator"><?php _e('Operator', 'slider_pro'); ?></label>
	<select name="slide[<?php echo $counter;?>][settings][dynamic_posts_operator]">
		<?php 
			$list = sliderpro_get_settings_list('dynamic_posts_operator');
			foreach ($list as $entry) {
				$selected = sliderpro_get_slide_setting($slide_settings, 'dynamic_posts_operator', 'dynamic') == $entry ? 'selected="selected"' : "";
				echo "<option value=\"$entry\" $selected>" . sliderpro_get_settings_pretty_name($entry) . "</option>";
			}
		?>
	</select>
	...
	<label title="dynamic_posts_orderby"><?php _e('Order By', 'slider_pro'); ?></label>
	<select name="slide[<?php echo $counter;?>][settings][dynamic_posts_orderby]">
		<?php 
	...
	<label title="dynamic_posts_order"><?php _e('Order', 'slider_pro'); ?></label>
	<select name="slide[<?php echo $counter;?>][settings][dynamic_posts_order]">
		<?php 
