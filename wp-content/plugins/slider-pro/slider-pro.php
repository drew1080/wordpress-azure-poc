...
add_action('wp_ajax_sliderpro_getting_started_close', 'sliderpro_getting_started_close');
...
function sliderpro_is_slider_pro_admin() {
	if (is_admin() && 
		...
		(isset($_GET['action']) && in_array($_GET['action'], array('sliderpro_add_new_slides', 'sliderpro_duplicate_slide', 'sliderpro_slider_preview', 
																   ...
																   'sliderpro_edit_custom_js_css', 'sliderpro_save_custom_js_css', 'sliderpro_getting_started_close'))))
		return true;
	else 
		return false;
}
...
function sliderpro_create_admin_bar_links() {
	if (!get_option('slider_pro_show_admin_bar_links') || current_user_can('subscriber'))
		return;
...
function sliderpro_load_admin_scripts() {
	if (get_option('slider_pro_enqueue_jquery') && get_option('slider_pro_enqueue_bundled_jquery')) {
		...
		wp_register_script('jquery', plugins_url('/slider-pro/js/jquery-1.9.1.min.js'));
	}	
	...
	$current_site_path = isset($current_site) ? $current_site->path : '';
	...
	wp_localize_script('slider-pro-admin-js', 'sp_js_vars', array(
		...
		'taxonomy_terms_limit' => __('For performance purposes, you can select a maximum of 5 terms. More details ', 'slider_pro') . 
									 '<a target="_blank" href="' . admin_url('admin.php?page=slider_pro_help#post-taxonomies') . '">' . __('here', 'slider_pro') . '</a>',
		'yes' => __('Yes', 'slider_pro'),
		'cancel' => __('Cancel', 'slider_pro'),
		'close' => __('Close', 'slider_pro'),
		...
		'rewrite_multisite_paths' => function_exists('is_multisite') && is_multisite() && !is_main_site() && get_option('slider_pro_multisite_path_rewrite'),
		'blog_id' => $blog_id, 
...
function sliderpro_load_slider_scripts() {
	...
	if (in_array('excanvas', $sliderpro_scripts_to_load) && $is_IE) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-slider-excanvas-js', plugins_url('/slider-pro/js/slider/excanvas.compiled.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-slider-excanvas-js', plugins_url('/slider-pro/js/slider/dev/excanvas.js'), false, SLIDER_PRO_VERSION);
	...
	if (in_array('mousewheel', $sliderpro_scripts_to_load) && get_option('slider_pro_enqueue_jquery_mousewheel')) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-slider-mousewheel-js', plugins_url('/slider-pro/js/slider/jquery.mousewheel.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-slider-mousewheel-js', plugins_url('/slider-pro/js/slider/dev/jquery.mousewheel.js'), false, SLIDER_PRO_VERSION);
	...
	if (in_array('lightbox', $sliderpro_scripts_to_load)) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-lightbox-js', plugins_url('/slider-pro/js/slider/jquery.prettyPhoto.custom.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-lightbox-js', plugins_url('/slider-pro/js/slider/dev/jquery.prettyPhoto.custom.js'), false, SLIDER_PRO_VERSION);
	...
	if (in_array('css3_transitions', $sliderpro_scripts_to_load)) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-css3-transitions-js', plugins_url('/slider-pro/js/slider/jquery.transition.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-css3-transitions-js', plugins_url('/slider-pro/js/slider/dev/jquery.transition.js'), false, SLIDER_PRO_VERSION);
	...
	if (in_array('vimeo_controller', $sliderpro_scripts_to_load)) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-vimeo-controller-js', plugins_url('/slider-pro/js/slider/froogaloop.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-vimeo-controller-js', plugins_url('/slider-pro/js/slider/dev/froogaloop.js'), false, SLIDER_PRO_VERSION);	
	...
	if (in_array('videojs_controller', $sliderpro_scripts_to_load) && !sliderpro_is_old_ie()) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-videojs-controller-js', plugins_url('/slider-pro/js/slider/video.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-videojs-controller-js', plugins_url('/slider-pro/js/slider/dev/video.js'), false, SLIDER_PRO_VERSION);		
	...
	if (in_array('jwplayer_controller', $sliderpro_scripts_to_load)) {
		wp_register_script('slider-pro-jwplayer-controller-js', $sliderpro_scripts_to_load['jwplayer_path'] . '/jwplayer.js', false, SLIDER_PRO_VERSION);
	...
	if (count(array_intersect(array('youtube_controller', 'vimeo_controller', 'html5_controller', 'videojs_controller', 'jwplayer_controller'), $sliderpro_scripts_to_load))) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-video-controller-js', plugins_url('/slider-pro/js/slider/jquery.videoController.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-video-controller-js', plugins_url('/slider-pro/js/slider/dev/jquery.videoController.js'), false, SLIDER_PRO_VERSION);		
	...
	if (in_array('touch_swipe', $sliderpro_scripts_to_load)) {
		if (get_option('slider_pro_use_compressed_scripts'))
			wp_register_script('slider-pro-touch-swipe-js', plugins_url('/slider-pro/js/slider/jquery.touchSwipe.min.js'), false, SLIDER_PRO_VERSION);
		else
			wp_register_script('slider-pro-touch-swipe-js', plugins_url('/slider-pro/js/slider/dev/jquery.touchSwipe.js'), false, SLIDER_PRO_VERSION);
	...
	if (in_array('slider', $sliderpro_scripts_to_load)) {
		if (get_option('slider_pro_enqueue_jquery_easing')) {
			if (get_option('slider_pro_use_compressed_scripts'))
				wp_register_script('slider-pro-slider-easing-js', plugins_url('/slider-pro/js/slider/jquery.easing.1.3.min.js'), false, SLIDER_PRO_VERSION);
			else
				wp_register_script('slider-pro-slider-easing-js', plugins_url('/slider-pro/js/slider/dev/jquery.easing.1.3.js'), false, SLIDER_PRO_VERSION);
...
function sliderpro_plugin_options_ui() {
	if (isset($_POST['plugin_options_update'])) {
		...
		if (isset($_POST['slider_pro_show_getting_started_message']))
			update_option('slider_pro_show_getting_started_message', true);
		else
			update_option('slider_pro_show_getting_started_message', false);

		if (isset($_POST['slider_pro_display_all_slider_options']))
			update_option('slider_pro_display_all_slider_options', true);
		else
			update_option('slider_pro_display_all_slider_options', false);
	}
...
*/
function sliderpro_get_panel_state($slider, $panel_name, $group = false) {
	$state;

	if (isset($slider))
		$state = isset($slider['panels_state'][$panel_name]) ? $slider['panels_state'][$panel_name] : ($group ? 'opened' : 'closed');
	else 
		$state = ($panel_name == 'publish' || $panel_name == 'general' || $group) ? 'opened' : 'closed';
...
/**
* Hide the Getting Started guide
*/
function sliderpro_getting_started_close() {
	update_option('slider_pro_show_getting_started_message', false);
...
function slider_pro($id, $atts = null, $content = null) {
	...
	foreach ($slides as $slide) {
		...
		if (sliderpro_get_slide_setting($slide['settings'], 'slide_type', 'dynamic') == 'posts') {
			...
			if ($dynamic_posts_taxonomies_raw != '') {
				...
				$dynamic_taxonomies = array_slice($dynamic_taxonomies, 0, 5);
				...
				foreach ($dynamic_taxonomies as $item_raw) {
					...
					$tax_item['operator'] = sliderpro_get_slide_setting($slide_settings, 'dynamic_posts_operator', 'dynamic');
			...
			$dynamic_gallery_type = sliderpro_get_slide_setting($slide_settings, 'dynamic_gallery_type', 'dynamic');
			...
			if ($dynamic_gallery_type == 'gallery-images') {
				$gallery_ids = array();
				$pattern = sliderpro_regex(array('gallery'));
				...
				foreach ($gallery_ids as $key => $value) {
					$gallery_image = get_post($value, ARRAY_A);
	...
	*/
	...
	$html_string .= SP_IND_1 . '<div class="slides">' . PHP_EOL;
	...
	foreach ($slides as $index => $slide) {
		...
		$html_string .= SP_IND_2 . '<div class="slide" ' . $lazy_loaded_image . '>' . PHP_EOL;
		...
		$html_string .= SP_IND_2 . '</div>' . PHP_EOL;
	}
	
	$html_string .= SP_IND_1 . '</div>' . PHP_EOL;
	$html_string .= '</div>';
	...
	return $html_string . PHP_EOL . PHP_EOL;
}
