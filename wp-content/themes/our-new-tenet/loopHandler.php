...
if (have_posts()) : 
	while (have_posts()) : the_post(); 
		$fast_fact_text[$fast_fact_counter] = '<div id="fast-fact" class="fast-fact" style="background-image: url(/wp-content/themes/our-new-tenet/images/bkgd-fastfact-' .  $background_colors[$background_color_count] . '.png)"><span class="fast-fact-content">' . get_the_content() . '</span></div>';
